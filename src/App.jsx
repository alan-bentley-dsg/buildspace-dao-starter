...
const tokenModule = sdk.getTokenModule(
  "0xeD5BBdBB5Fea9c929EaE94b379f622588B9599aA"
);

const voteModule = sdk.getVoteModule(
  "0x92693b63eB9671faA3f58955A142676Df258B80C",
);
...
const App = () => {
  ...
  // error handling if user is not on rinkeby test network
  ...
  if (hasClaimedNFT) {
    return (
      <div className="member-page">
        <h1>BeagleDAO Member Page</h1>
        <h2>🐶 Congratulations on being a member! 🐶</h2>
        <p>Connected Wallet: <b>{shortenAddress(address)}</b></p>
        <div>
          <div>
            <h2>Member List</h2>
